...
# read csv files 
gj_2002 <- read.csv("Nhis_heals_gj_2002.csv")
gj_2003 <- read.csv("Nhis_heals_gj_2003.csv")

gy_2002 <- read.csv("Nhis_heals_gy20_t1_2002.csv")
gy_2003 <- read.csv("Nhis_heals_gy20_t1_2003.csv")

jk_2002 <- read.csv("Nhis_heals_jk_2002.csv")
jk_2003 <- read.csv("Nhis_heals_jk_2003.csv")
