...
Now let's take a look at the meanings of each column. I will explain the columns divided into **KDA**(`Kills`, `Deaths`, `Assists`, `FirstBlood`), Object (`TowersDestroyed`, `EliteMonsters`, `Dragons`, `Heralds`), CS(Creep Score, `TotalMinionsKilled`, `TotalJungleMinionsKilled`, `CSPerMin`), important metrics(`TotalGold`, `GoldDiff`, `GoldPerMin`, `TotalExperience`, `ExperienceDiff`) and Ward(`WardsPlaced`, `WardsDestroyed`) according to the meanings.
...
```{r, echo=FALSE, fig.cap = "Dragons and Herald"}
include_graphics("https://static.news.zumst.com/images/29/2019/10/25/2a2b88f80a5b4a409e64f47587cae136.jpg")
include_graphics("https://ww.namu.la/s/23df70c3db001d091b07979dea6afbc0ec73f1a8628a4e7ad0bd367c9564c28fe88d997adb224dab13589ec09185c35ad3bef8e36e8ff28b349c0744f700b42cc1b2eea6cecd30fbd63f9b591053edfc11ac328f99f7cebf1a0c4b0d8e757ca3")
```
