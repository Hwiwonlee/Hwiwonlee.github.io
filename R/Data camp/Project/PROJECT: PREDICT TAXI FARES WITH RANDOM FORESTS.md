몇 번 사용해본 random forest를 이용한 분석 예제가 있길래 해보기로 했다. ggmap을 이용한 시각화가 인상적이었다.  
...
#### random forest를 이용한 prediction value에 ggmap과 stat_summary_2d를 이용한 시각화 1)
```r
...
#### random forest를 이용한 prediction value에 ggmap과 stat_summary_2d를 이용한 시각화 2)
```r
